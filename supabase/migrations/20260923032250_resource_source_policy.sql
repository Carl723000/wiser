...
declare previous platform_private.resource_policy_versions; role_count integer;
begin
 ...
 where project_id=new.project_id and (policy_id=new.policy_id or resource=new.resource)
