...
values
  ...
  ('b3000000-0000-4000-8000-000000000004', 'data.geo.read'),
  ('b3000000-0000-4000-8000-000000000004', 'data.graph.read'),
  ('b3000000-0000-4000-8000-000000000004', 'data.ingestion.write'),
  ('b3000000-0000-4000-8000-000000000004', 'data.knowledge.read'),
  ('b3000000-0000-4000-8000-000000000004', 'data.operation.read'),
  ('b3000000-0000-4000-8000-000000000004', 'data.publish'),
  ('b3000000-0000-4000-8000-000000000004', 'data.query.execute'),
  ('b3000000-0000-4000-8000-000000000004', 'data.search.execute'),
  ('b3000000-0000-4000-8000-000000000005', 'data.catalog.read'),
  ('b3000000-0000-4000-8000-000000000005', 'data.geo.read'),
  ('b3000000-0000-4000-8000-000000000005', 'data.graph.read'),
  ('b3000000-0000-4000-8000-000000000005', 'data.knowledge.read'),
  ('b3000000-0000-4000-8000-000000000005', 'data.operation.read'),
  ('b3000000-0000-4000-8000-000000000005', 'data.query'),
  ('b3000000-0000-4000-8000-000000000005', 'data.query.execute'),
  ('b3000000-0000-4000-8000-000000000005', 'data.search.execute')
