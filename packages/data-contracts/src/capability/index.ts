...
import {
  ...
  ReviewReconciliationOutputSchema,
...
const capabilityRegistry = {
  ...
  'data.reconciliation.create': defineCapability({
    id: 'data.reconciliation.create',
    version: '1.0.0',
    kind: 'command',
    inputSchema: CreateReconciliationInputSchema,
    outputSchema: CreateReconciliationOutputSchema,
    requiredScopes: [
      'data.query.execute',
      'data.catalog.read',
  ...
  'data.reconciliation.get': defineCapability({
    id: 'data.reconciliation.get',
    version: '1.0.0',
    kind: 'query',
    inputSchema: GetReconciliationInputSchema,
    outputSchema: GetReconciliationOutputSchema,
    requiredScopes: ['data.query.execute', 'data.catalog.read'],
    maxSecurityLevel: 'L3_CONFIDENTIAL',
    executionMode: 'SYNCHRONOUS',
    timeout: 30000,
  ...
  'data.reconciliation.review': defineCapability({
    id: 'data.reconciliation.review',
    version: '1.0.0',
    kind: 'command',
    inputSchema: ReviewReconciliationInputSchema,
    outputSchema: ReviewReconciliationOutputSchema,
    requiredScopes: ['data.query.execute', 'data.catalog.read', 'data.publish'],
    maxSecurityLevel: 'L3_CONFIDENTIAL',
    executionMode: 'SYNCHRONOUS',
    timeout: 30000,
    idempotent: true,
  ...
  'data.reconciliation.list': defineCapability({
    id: 'data.reconciliation.list',
    version: '1.0.0',
    kind: 'query',
    inputSchema: ListReconciliationsInputSchema,
    outputSchema: ListReconciliationsOutputSchema,
    requiredScopes: ['data.query.execute', 'data.catalog.read'],
    maxSecurityLevel: 'L3_CONFIDENTIAL',
    executionMode: 'SYNCHRONOUS',
    timeout: 30000,
